...
/**
 * This is the model base class for the table "{{loans_activities}}".
 * DO NOT MODIFY THIS FILE! It is automatically generated by giix.
 * If any changes are necessary, you must set or override the required
 * property or method in class "LoansActivities".
 *
 * Columns in table "{{loans_activities}}" available as properties of the model,
 ...
 */
abstract class BaseLoansActivities extends GxActiveRecord {
	...
	public function relations() {
		return array(
			'loans' => array(self::HAS_MANY, 'Loans', 'id_loans_activity'),
		);
	}
