...
class m150312_082029_create_interest_categories_cache_and_functions extends CDbMigration
{
	public function up()
	{
        $this->execute("
        ...
        $this->execute("ALTER FUNCTION _get_member_category_rating(integer, integer, date, date) OWNER TO tgd;");
        ...
        $this->execute('
            CREATE OR REPLACE FUNCTION _getsubcategories(IN id_p integer)
        ...
        $this->execute("ALTER FUNCTION _getsubcategories(integer) OWNER TO tgd;");
        ...
        $this->execute("ALTER FUNCTION _getcategorycount(integer, integer, date, date) OWNER TO tgd;");
	...
	{
		echo "m150312_082029_create_interest_categories_cache_and_functions does not support migration down.\n";
		return false;
	}
