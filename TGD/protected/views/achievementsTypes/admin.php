...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('achievements-types-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<?php $count = count($columns);
	...
	<p id="select-fields-buttons" class="clearfix">
        <?php echo CHtml::link('Export!',array('/achievementsTypes/excel'), array('id'=>'export', 'class' => 'btn btn-success')); ?> 
