...
array(
			'name' => 'category',
			'type' => 'raw',
			'value' => $model->category !== null ? GxHtml::link(GxHtml::encode(GxHtml::valueEx($model->category)), array('threatsTypes/view', 'id' => GxActiveRecord::extractPkValue($model->category, true))) : null,
			),
'name',
'url',
	),
