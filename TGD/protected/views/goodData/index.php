                ...
                <div>
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-2"><img src="<?php echo Yii::app()->baseUrl; ?>/uploads/flags/<?php echo strtolower($loan->code); ?>.png" class="flag"/><?php echo $loan->country; ?><a href="#" class="partner subtext"><?php echo $loan->partner; ?></a></div>
