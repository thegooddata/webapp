                ...
                <div class="col-xs-12 tgd-no-horizontal-padding">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active legal" id="terms">
                            ...
                            <p>We ask that you review our <a href="<?php echo Yii::app()->controller->createAbsoluteUrl("/site/legal");?>#privacy">Privacy Policy</a>, so that you are aware of how we collect and use your data, as well as the rights you have to access or cancel it at any time. Because our Services are used by people all over the world, personal information that we collect may be stored and processed in the United Kingdom or any other country. By using our services, you consent to any such transfer of information outside your country.</p>
                            ...
                            <p>We make all of our code available under open-source licenses that constitute separate written agreements. Our open-source code can be found at <a href="https://github.com/thegooddata">https://github.com/thegooddata</a>. There may be provisions in the open-source licenses that expressly override these terms.</p>
                            ...
                            <h2>Restrictions</h2>
                            <p>You agree that you won&rsquo;t attempt to or in fact do the following to the Services: probe, scan, or test the vulnerability of any system or network; breach or otherwise circumvent any security or authentication measures; access, tamper with, or use non-public areas of the Services, areas of the Services you haven&rsquo;t been invited to including TheGoodData&rsquo;s or our service providers&rsquo; computer systems.</p>
                            ...
                            <p>All content submitted to us available through the Services is the sole responsibility of the person who submitted the content. TheGoodData doesn&rsquo;t control, monitor, or have any detailed knowledge of the content. Therefore, you may be exposed to info that&rsquo;s incorrect, offensive, or otherwise objectionable. TheGoodData shall not be liable for the content and other info spread or delivered through or in connection with the Services. You agree that you shall bear all risks associated with the use of such info. We have no responsibility to remove content you make public &mdash; for example, comments you make on our blog &mdash; so please be careful with what you post.</p>

                            <h2>Linked sites and services</h2>
                            <p>We choose our third-party providers and payment processors carefully but we&rsquo;re not responsible for the practices employed by websites linked to or from the Services, nor their information or content. When you use a link to go from the Services to another website, your browsing and interaction is subject to that website&#39;s own rules and policies, not ours. Please read over those rules and policies before proceeding.</p>
                            <h2>Support</h2>
                            ...
                            <h2>Waiver</h2>
                            <p>The waiver or failure of TheGoodData to exercise any right provided for in the Terms shall not be deemed a waiver of any further or future right under the Terms.</p>
