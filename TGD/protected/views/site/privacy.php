    ...
    <div class="container">
        <div class="row">
            <div id="contract" class="col-sm-16 col-md-16 col-lg-16">        
                ...
                <ol start="1">
                    <li><a class="inner-link" data-ref="#contract" href="#item-1">Our browser extension does not collect any Personally Identifiable Information (PII) of Service Users or store any cookies.</a></li>
                    <li><a class="inner-link" data-ref="#contract" href="#item-2">Anonymous data will only be stored with your permission.</a></li>
                    <li><a class="inner-link" data-ref="#contract" href="#item-3">Anonymous data will only be traded with third parties if you provide an additional and limited permission to do so.</a></li>
                    <li><a class="inner-link" data-ref="#contract" href="#item-4">Only if you request to become a cooperative Member, we will have to store as minimum PII as possible.</a></li>
                    <li><a class="inner-link" data-ref="#contract" href="#item-5">We will always do our best effort to avoid unwanted access to your data by third parties.</a></li>
                    <li><a class="inner-link" data-ref="#contract" href="#item-6">We will provide you access to the data we have about yourself, as well as the possibility to correct it or remove it from our servers at any time without delay.</a></li>
                </ol>
                <ol start="1">
