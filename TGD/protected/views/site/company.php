            ...
            <div class="row">
                ...
                <section class="tgd-box col-sm-16 col-md-16 col-lg-16">
                    ...
                    <div class="our_way_desc tgd-box col-sm-16 col-md-8 col-lg-8">
                        <h4>he best way we know to ensure your collaboration and guarantee continued transparency is to make you the majority owners of TheGoodData. In doing so, our interests will always be aligned with yours, which means we’ll never sell out to another company so your data will always be safe with us.</h4>
