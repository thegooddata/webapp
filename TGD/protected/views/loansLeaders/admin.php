...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('loans-leaders-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<?php $count = count($columns);
	...
	<p id="select-fields-buttons" class="clearfix">
        <?php echo CHtml::link('Export!',array('/loansLeaders/excel'), array('id'=>'export', 'class' => 'btn btn-success')); ?>
